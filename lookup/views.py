...
#https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=20002&distance=25&API_KEY=1F3F03ED-7B5F-4B56-B670-FEF90B4F6A31
def home(request):
	import json
	import requests
	...
	if request.method == "POST":
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=25&API_KEY=1F3F03ED-7B5F-4B56-B670-FEF90B4F6A31")
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=20002&distance=25&API_KEY=1F3F03ED-7B5F-4B56-B670-FEF90B4F6A31")
